...
var Blogmail = /** @class */ (function (_super) {
    __extends(Blogmail, _super);
    function Blogmail(props) {
        var _this = _super.call(this, props) || this;
        _this.id = uniqueId("blogmail");
        return _this;
    }
    Blogmail.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Script, { url: "https://blogmail.co/v1/bm.js", onCreate: this.handleScriptCreate.bind(this), onError: this.handleScriptError.bind(this), onLoad: this.handleScriptLoad.bind(this) }),
            React.createElement("div", { id: this.id },
                React.createElement("script", { type: "application/json", dangerouslySetInnerHTML: this.getInnerHtml() }))));
    };
    Blogmail.prototype.getInnerHtml = function () {
        return {
    ...
    Blogmail.prototype.handleScriptCreate = function () {
        // console.log("handleScriptCreate")
    };
    Blogmail.prototype.handleScriptError = function () {
        // console.log("handleScriptError")
    };
    Blogmail.prototype.handleScriptLoad = function () {
...
var Blogmail$1 = /*#__PURE__*/function (_React$Component) {
  _inherits(Blogmail$1, _React$Component);

  var _super = _createSuper(Blogmail$1);

  function Blogmail$1(_props) {
    var _this;

    _classCallCheck(this, Blogmail$1);
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      return /*#__PURE__*/React__default.createElement(Blogmail, _extends({}, props, {
        newsletterId: _this.newsletterId
      }));
    });

    _this.newsletterId = typeof GATSBY_BLOGMAIL_NEWSLETTERID !== "undefined" && GATSBY_BLOGMAIL_NEWSLETTERID !== "" ? GATSBY_BLOGMAIL_NEWSLETTERID : "";
    return _this;
  } // componentDidMount() {
  ...
  return Blogmail$1;
}(React__default.Component); // Blogmail.propTypes = {

module.exports = Blogmail$1;
